...
export const testimonials = [
  {
    ...
    quote:
      "10X Wealth Creators transformed my mindset and helped me build multiple income streams. Thanks to Sampath Kumar and Ram Prasad's mentorship, I now run a successful online business.",
    mentor: "Sampath Kumar & Ram Prasad",
  },
  {
    id: "rajitha",
    title: "From paycheck cycle to new possibilities",
    name: "Rajitha",
    role: "Community member",
    image: siteImages.testimonials.rajitha,
    quote:
      "I was stuck in a paycheck-to-paycheck cycle, but this program changed everything. The strategies on financial freedom opened my eyes, and now I am building passive income sources.",
    mentor: "Ram Prasad",
  },
  {
    id: "mindset-shift",
